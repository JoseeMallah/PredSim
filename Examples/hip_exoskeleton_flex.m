...
S.misc.save_folder  = fullfile(pathExDir,'ExampleResults','HipExo', 'SUBJ25', 'Flex');  
...
exo1.peak_torque = 0.286 * bm; % [Nm] mean
exo1.peak_time = 65.9; % [%] mean
exo1.rise_time = 33.4; % [%] mean
exo1.fall_time = 24.7;  % [%] mean
