% --------------------------------------------------------------------------
% ankle_knee_exoskeleton
%   Simulate walking with a knee and ankle exoskeleton that provides knee flexion
%   and ankle plantarflexion torque in function of the progression within a stride.
...
S.misc.save_folder  = fullfile(pathExDir,'ExampleResults','AnkleKneeExo', 'SUBJ05_26', 'PFFlex');  

% either choose "quasi-random" or give the path to a .mot file you want to use as initial guess
%S.solver.IG_selection = fullfile(S.misc.main_path,'OCP','IK_Guess_Full_GC.mot');
S.solver.IG_selection = fullfile(S.misc.main_path,'Subjects',S.subject.name,'SUBJ05_ik_deg_GC.mot');
...
exo1.function_name = 'ankleKneeFranks2021';
...
exo1.peak_time_pf = 54.8; % [%] mean
exo1.rise_time_pf = 29.7; % [%] mean
exo1.fall_time_pf = 16.1;  % [%] mean
exo1.peak_torque_kf = 0.145 * bm; % [Nm] mean
exo1.peak_time_kf = 60.2; % [%] mean
exo1.rise_time_kf = 17.5; % [%] mean
exo1.fall_time_kf = 8.4;  % [%] mean
