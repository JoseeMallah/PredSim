...
S.misc.save_folder  = fullfile(pathExDir,'ExampleResults','HipExo', 'SUBJ28_26', 'ExtFlex');  
...
exo1.function_name = 'hipExoExtFlex';
...
exo1.peak_torque_ext = 0.404 * bm; % [Nm] mean
exo1.peak_time_ext = 26.2; % [%] mean
exo1.rise_time_ext = 16.4; % [%] mean
exo1.fall_time_ext = 31.8;  % [%] mean
exo1.peak_torque_flex = 0.286 * bm; % [Nm] mean
exo1.peak_time_flex = 65.9; % [%] mean
exo1.rise_time_flex = 33.4; % [%] mean
