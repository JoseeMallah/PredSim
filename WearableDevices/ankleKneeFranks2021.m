function [exo] = ankleKneeFranks2021(init, settings_orthosis)
% --------------------------------------------------------------------------
% ankleKneeFranks2021
%   Ankle (plantarflexion) and knee (flexion) exoskeleton that applies
%   a torque profile (torque in function of stride) to the ankle and knee. 
%
%   References
