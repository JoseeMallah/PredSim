function [exo] = hipExoExt(init, settings_orthosis)
% --------------------------------------------------------------------------
% hipExoExt
%   Hip extension exoskeleton that applies a torque profile (torque in function of
%   stride) to the hip. 
%
%   References
...
%       - function_name = hipExoExt  i.e. name of this function   
...
%       - peak_time:        peak offset time from 84% prev (-16%) to peak
