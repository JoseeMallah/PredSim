function [exo] = ankleHipFranks2021(init, settings_orthosis)
% --------------------------------------------------------------------------
% ankleHipFranks2021
%   Ankle (plantarflexion) and hip (extension/flexion) exoskeleton that applies
%   a torque profile (torque in function of stride) to the ankle and hip. 
%
%   References
...
%       - dependencies_path2 path to desired_torque_generator_hip_extension
%       and desired_torque_generator_modif
